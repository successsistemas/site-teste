...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<? foreach($_POST["relatorio_campos"] as $relatorio_campos){ // lista os campos selecionados para o relatório ?>
			...
			if($relatorio_campos=="data_inicio2"){echo "Data de agendamento";}
			...
			if($relatorio_campos=="atendimento"){echo "Atendimento";}
    ...
    <?php do { ?>
            ...
            foreach($_POST["relatorio_campos"] as $relatorio_campos){ // lista os campos selecionados para o relatório 
					...
					if($relatorio_campos=="data_inicio2"){$campo = date('d-m-Y H:i', strtotime($campo));}
