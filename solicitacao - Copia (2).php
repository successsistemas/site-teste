...
SELECT 
    ...
    (
        ...
        FROM 
            suporte 
        WHERE 
            suporte.contrato = solicitacao.contrato and 
            suporte.tipo_suporte = 'r' and 
            suporte.status_flag = 'a'
...
mysql_select_db($database_conexao, $conexao);
$query_filtro_operador = "SELECT IdUsuario, nome, usuario FROM usuarios ORDER BY nome ASC";
        ...
        <div id="corpo_solicitacao" style="cursor: pointer">
            ...
            <script type="text/javascript">
                var dados = [
                    ...
                    <?php do { ?>
                        ...
                        <? if($row_solicitacao['situacao']=="em análise" and $row_solicitacao['previsao_analise']!="0000-00-00 00:00:00") { ?>
                            <? $previsao_data_exibir = $row_solicitacao['previsao_analise_inicio']; ?>
                        <? } else ?>
                ...
                jQuery('#solicitacao').jqGrid({
                    data: dados,
                    datatype: 'local',
                    colNames: ['Núm', 'Título', 'Empresa', 'Reclamação', 'Solicitante', 'Operador', 'Executante', 'Testador', 'Criação', 'Data Suporte', 'Previsão', 'Dias em Atraso', 'Validação', 'Tipo', 'Status', 'Prior.', 'Situação', ''],
                    colModel: [{
                            name: 'id',
                            index: 'id',
                            width: 25,
