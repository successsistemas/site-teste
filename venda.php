...
$query_venda = "
SELECT 
venda.id, venda.status, venda.atendimento, venda.situacao, venda.data_venda, venda.id_usuario_responsavel, 
...

{
    ...
    atendimento:"<span title='<? echo @$atendimento_array[$row_venda['atendimento']]['titulo']; ?>' class='<? echo $cor_css; ?>'><?php echo $row_venda['atendimento']; ?></span>",
...
jQuery('#venda').jqGrid({
	data:dados,
	datatype: 'local',
	colNames:['Núm','Contrato','Cliente',<? if($row_usuario['controle_venda'] == "Y"){ ?>'Praça',<? } ?>'Responsável','Status','Atend.','Situação','Data criação',''],
	colModel :[ 
