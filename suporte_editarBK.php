...
if($row_suporte_editar['id_usuario_responsavel']==$row_usuario['IdUsuario']) {
		$updateSQL_leu = sprintf("UPDATE suporte SET usuario_responsavel_leu=%s WHERE id=%s",
...
if($row_suporte_editar['id_usuario_envolvido']==$row_usuario['IdUsuario']) {
		$updateSQL_leu = sprintf("UPDATE suporte SET usuario_envolvido_leu=%s WHERE id=%s",
						   GetSQLValueString(date("Y-m-d H:i:s"), "date"),
						   GetSQLValueString($row_suporte_editar['id'], "int"));
...
SELECT codigo1, nome1, endereco1, bairro1, cidade1, uf1, telefone1, comercio1, cep1, ultcompra1, atraso1, status1, flag1, tipo1 
FROM da01 
...
GetSQLValueString($row_manutencao_dados['cliente17'], "text"), GetSQLValueString($colname_contrato, "text"));
...
$query_suporte_formulario_listar2 = sprintf("SELECT IdFormulario FROM suporte_formulario WHERE codigo_empresa = %s  AND contrato = %s  and status_flag <> 'c' ORDER BY IdFormulario DESC", 
GetSQLValueString($row_manutencao_dados['cliente17'], "text"), GetSQLValueString($colname_contrato, "text"));
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        <? if($tipo_suporte_inloco == "cs"){ ?>
			Suporte ao cliente (in-loco: Sim) n° <? echo $row_suporte['id']; ?>
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        <? if($tipo_suporte_inloco == "cs"){ ?>
            ...
            <strong><?php if($row_suporte['adiantamento_visita']=="s"){echo "Sim";} else{echo "Não";} ?></strong>
		<? } ?>
        ...
        <? if($row_suporte_formulario_atual['tipo_formulario']=="Treinamento" or $row_suporte_formulario_atual['tipo_formulario']=="Reclamacao"){ ?>
            ...
            | <span class="label_solicitacao">Abater créditos por formulário atual:</span> 
            <strong><?php if($row_suporte_formulario_atual['creditar']=="n"){echo "Não";} if($row_suporte_formulario_atual['creditar']=="s"){echo "Sim";} ?></strong>
            <? } ?>
		<? } ?>
		...
		){ ?><strong>Sim</strong><? } else { ?><strong>Não</strong><? } ?>
        </td>
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        Optante por acumulo de manutenção: <strong><?php if($row_manutencao_dados['optacuv17']=="N"){echo "Não";} if($row_manutencao_dados['optacuv17']=="S"){echo "Sim";} ?></strong>
        </td>
...
(($row_usuario['controle_suporte']=="Y" or  $row_usuario['suporte_operador_parceiro']=="Y") and 
		...
		($row_usuario['suporte_operador_parceiro']=="Y" and ($row_suporte['praca'] == $row_usuario['praca'] or $tipo_suporte_inloco == "cn" or $tipo_suporte_inloco == "p"))
		) and 
...
(($row_usuario['controle_suporte']=="Y" or $row_usuario['suporte_operador_parceiro']=="Y") and
		...
		$tipo_suporte_inloco == "cs" and 
		($row_suporte_formulario_atual['tipo_formulario']=="Extra" or $row_suporte_formulario_atual['tipo_formulario']=="Treinamento" or $row_suporte_formulario_atual['tipo_formulario']=="Reclamacao")
...
<!-- Estornar -->
<? if(
	(($row_usuario['controle_suporte']=="Y") or ($row_suporte['praca'] == $row_usuario['praca'] and $row_usuario['controle_praca'] == "Y")) and 
	($tipo_suporte_inloco == "cs")
){ ?>										  
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;">
        ...
        <?php do { ?>
        <tr bgcolor="<? if(($contador_reclamacao_vinculo % 2)==1){echo "#F1F1F1";}else{echo "#FFFFFF";} ?>">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;">
        ...
        <tr bgcolor="#F1F1F1">
            ...
            <td style="padding: 5px;" width="150"><strong>Tipo de formulário</strong></td>
        ...
        <tr bgcolor="<? if(($contador_suporte_formulario_listar % 2)==1){echo "#FFFFFF";}else{echo "#F1F1F1";} ?>">
            ...
            <? if($row_suporte_formulario_listar['situacao']!="encerrado"){ ?>
				...
				<? if($row_suporte_formulario_listar['tipo_formulario']=="Extra" and $contador_form_extra=="1"){ ?>            	
                ...
                <? if($row_suporte_formulario_listar['tipo_formulario']=="Treinamento" and $contador_form_treinamento=="1"){ ?>
                        <a href="suporte_formulario.php?codigo_empresa=<?php echo $row_suporte_formulario_listar['codigo_empresa']; ?>&contrato=<?php echo $row_suporte_formulario_listar['contrato']; ?>&IdFormulario=<?php echo $row_suporte_formulario_listar['IdFormulario']; ?>" target="_blank"><img src="imagens/visualizar.png" border="0" /></a>
                <? } ?>
                
                <? if($row_suporte_formulario_listar['tipo_formulario']=="Manutencao" and $contador_form_manutencao=="1"){ ?>
                    <a href="suporte_formulario.php?codigo_empresa=<?php echo $row_suporte_formulario_listar['codigo_empresa']; ?>&contrato=<?php echo $row_suporte_formulario_listar['contrato']; ?>&IdFormulario=<?php echo $row_suporte_formulario_listar['IdFormulario']; ?>" target="_blank"><img src="imagens/visualizar.png" border="0" /></a>           
                <? } ?>
                
                <? if($row_suporte_formulario_listar['tipo_formulario']=="Cobranca" and $contador_form_cobranca=="1"){ ?>
                    <a href="suporte_formulario.php?codigo_empresa=<?php echo $row_suporte_formulario_listar['codigo_empresa']; ?>&contrato=<?php echo $row_suporte_formulario_listar['contrato']; ?>&IdFormulario=<?php echo $row_suporte_formulario_listar['IdFormulario']; ?>" target="_blank"><img src="imagens/visualizar.png" border="0" /></a>           
                <? } ?>
                
                <? if($row_suporte_formulario_listar['tipo_formulario']=="Reclamacao" and $contador_form_reclamacao=="1"){ ?>
                        <a href="suporte_formulario.php?codigo_empresa=<?php echo $row_suporte_formulario_listar['codigo_empresa']; ?>&contrato=<?php echo $row_suporte_formulario_listar['contrato']; ?>&IdFormulario=<?php echo $row_suporte_formulario_listar['IdFormulario']; ?>" target="_blank"><img src="imagens/visualizar.png" border="0" /></a>
                <? } ?>
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;">
        ...
        <?php do { ?>
        <tr bgcolor="<? if(($contador_reclamacao_suporte % 2)==1){echo "#F1F1F1";}else{echo "#FFFFFF";} ?>">
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
	...
	<? if($row_suporte['situacao']!="solucionada" and $row_suporte['situacao']!="cancelada"){ ?>
            ...
            <br>
            <? if($row_suporte['usuario_responsavel_leu']!=""){ echo date('d-m-Y - H:i:s', strtotime($row_suporte['usuario_responsavel_leu'])); } else { echo "não leu"; } ?>
            ...
            <br>
            <? if($row_suporte['usuario_envolvido_leu']!=""){ echo date('d-m-Y - H:i:s', strtotime($row_suporte['usuario_envolvido_leu'])); } else { echo "não leu"; } ?>
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <!-- anexos -->
    <a href="suporte_editar_upload.php?id_suporte=<? echo $row_suporte['id']; ?>&situacao=&acao=Arquivos em  anexo&resposta=&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=<? echo $suporte_editar_tabela_height; ?>&width=<? echo $suporte_editar_tabela_width; ?>&modal=true"  class="thickbox" id="botao_geral" style="width: 150px;">Arquivos em anexo (<? echo $totalRows_arquivos_anexos; ?>)</a>
    <!-- fim - anexos -->
