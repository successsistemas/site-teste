...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
		...
		<? if($row_prospeccao['atendimento'] <> ''){ ?>
			<br>
			<span class="label_solicitacao">Atendimento: </span><? echo @$atendimento_array[$row_prospeccao['atendimento']]['titulo']; ?>
		<? } ?>
		</td>
...
if(
	...
	$row_prospeccao['atendimento'] <> "SolCan" and  
	$row_prospeccao['atendimento'] <> "FinAte" and 
	(
		($row_usuario['nivel_prospeccao'] == 1 and $row_usuario['praca'] == $row_prospeccao['praca']) or 
		($row_usuario['nivel_prospeccao'] == 2 and $row_usuario['praca'] == $row_prospeccao['praca']) or 
		($row_usuario['nivel_prospeccao'] == 3 and $row_usuario['praca'] == $row_prospeccao['praca']) or 
	...
	<table cellspacing="0" cellpadding="0" width="100%">
		<tr>
			<td style="text-align:left">
				...
				<!-- Iniciar atendimento ========================================================================================================================================= -->
				<? if ($row_prospeccao['atendimento'] == NULL) { ?>
					<a href="prospeccao_editar_tabela.php?id_prospeccao=<? echo $row_prospeccao['id']; ?>&interacao=<? echo $row_prospeccao['interacao']; ?>&situacao=&acao=Iniciar atendimento&resposta=&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=<? echo $prospeccao_editar_tabela_height; ?>&width=<? echo $prospeccao_editar_tabela_width; ?>&modal=true" class="thickbox" id="botao_geral2" style="width: 120px;">Iniciar Atendimento</a>
				<? } ?>
				...
				<? 
				if (
					$row_prospeccao['atendimento'] == NULL or 
					$row_prospeccao['atendimento'] == "IniAte" or 
					$row_prospeccao['atendimento'] == "SolRea" or 
					$row_prospeccao['atendimento'] == "PenAte"
				) { 
				?>
					<a href="prospeccao_editar_tabela.php?id_prospeccao=<? echo $row_prospeccao['id']; ?>&interacao=<? echo $row_prospeccao['interacao']; ?>&situacao=&acao=Reagendar atendimento&resposta=&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=<? echo $prospeccao_editar_tabela_height; ?>&width=<? echo $prospeccao_editar_tabela_width; ?>&modal=true" class="thickbox" id="botao_geral2" style="width: 140px;">Reagendar Atendimento</a>
				<? } ?>
				...
				?>
					<a href="prospeccao_editar_tabela.php?id_prospeccao=<? echo $row_prospeccao['id']; ?>&interacao=<? echo $row_prospeccao['interacao']; ?>&situacao=&acao=Cancelar atendimento&resposta=&placeValuesBeforeTB_=savedValues&TB_iframe=true&height=<? echo $prospeccao_editar_tabela_height; ?>&width=<? echo $prospeccao_editar_tabela_width; ?>&modal=true" class="thickbox" id="botao_geral2" style="width: 130px;">Cancelar Atendimento</a>
				<? } ?>
