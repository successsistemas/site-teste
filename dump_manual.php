...
if($row_usuario["administrador_site"] != "Y"){ die("Acesso nao Autorizado"); exit; } // restringe acesso somente ao usuário administrador do site
...
echo "Data da última atualização: ";
