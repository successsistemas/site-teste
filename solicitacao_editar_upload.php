...
SELECT 
  ...
  solicitacao_descricoes.data 
FROM 
  solicitacao_arquivos 
LEFT JOIN 
  solicitacao_descricoes ON solicitacao_descricoes.id_arquivo = solicitacao_arquivos.id_arquivo 
WHERE 
  solicitacao_arquivos.id_solicitacao = %s 
ORDER BY 
  solicitacao_arquivos.id_arquivo DESC
", 
