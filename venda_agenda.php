...
if (isset($_GET["usuario_atual"])) { 
	...
	echo $_GET["id_usuario_atual"] = $row_usuario_atual["IdUsuario"];
...
if( $data_atual_ativo == "1" ) {
		...
		$where .= " and venda_agenda.data_inicio between '$colname_venda_data_inicio_fim 00:00:00' and '$colname_venda_data_inicio_fim 23:59:59' ";
...
// se NÃO existe filtro de data_atual
		...
		$where .= " and venda_agenda.data_inicio <= '$colname_venda_data_inicio_fim 23:59:59' ";
...
$query_venda = "
SELECT 
venda_agenda.id_venda, venda_agenda.data, venda_agenda.data_inicio, venda_agenda.descricao,
...
FROM venda_agenda 
INNER JOIN venda ON venda_agenda.id_venda = venda.id
WHERE $where and (venda_agenda.status = 'a' or venda_agenda.status = 'g')
ORDER BY venda_agenda.data ASC";
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        <form method="get" id="form_usuario_responsavel_alterar" name="form_usuario_responsavel_alterar" action="venda_agenda_popup.php">
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td style="text-align:left">
            ...
            <? funcao_agenda_calendario($dia, $mes, $ano, 'venda_agenda_popup.php?id_usuario_atual='.$row_usuario_atual['IdUsuario'].'&'); ?>
            </div>
            <!-- funcao_agenda_calendário -->
		</td>
	</tr>
...
<?php do { ?>
{
	...
	visualizar:"<? echo "<a href='venda_editar.php?id_venda=".$row_venda['id']."&padrao=sim' target='_blank'><img src='imagens/visualizar.png' border='0' /></a>"; ?>"
},
...
?>
<a href="venda_agenda_popup.php?id_usuario_atual=<? echo $row_usuario_atual['IdUsuario']; ?>&data_atual=<? echo $data_ant; ?>" class="botao_geral2" style="width: 150px">&lt;&lt; anterior</a>

<a href="venda_agenda_popup.php?id_usuario_atual=<? echo $row_usuario_atual['IdUsuario']; ?>&data_atual=<? echo $data_pro; ?>" class="botao_geral2" style="width: 150px">próximo &gt;&gt;</a>
...
<form action="venda_agenda_imprimir.php" method="post" target="_blank" id="form" name="form">
