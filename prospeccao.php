...
$query_prospeccao = "
SELECT 
prospeccao.id, prospeccao.status, prospeccao.atendimento, prospeccao.situacao, prospeccao.data_prospeccao, prospeccao.id_usuario_responsavel, prospeccao.praca, prospeccao.id_contador, prospeccao.sistema_possui, prospeccao.nivel_interesse, 
...

{
    ...
    atendimento:"<span title='<? echo @$atendimento_array[$row_prospeccao['atendimento']]['titulo']; ?>' class='<? echo $cor_css; ?>'><?php echo $row_prospeccao['atendimento']; ?></span>",
...
jQuery('#prospeccao').jqGrid({
	data:dados,
	datatype: 'local',
	colNames:['Núm','Cliente',<? if($row_usuario['controle_prospeccao'] == "Y"){ ?>'Praça',<? } ?>'Responsável','Contador','Possui Soft.','Interesse','Última Visita','Status','Atend.','Situação','Data',''],
	colModel :[ 
