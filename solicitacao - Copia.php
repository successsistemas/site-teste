...
if( (isset($_GET["titulo"])) && ($_GET['titulo'] !="") ) {
	...
	$where .= " and titulo LIKE '%$colname_solicitacao_titulo%' ";
} 
...
if( (isset($_GET["versao"])) && ($_GET['versao'] !="") ) {
	$colname_solicitacao_versao = GetSQLValueString($_GET["versao"], "string");
	$where .= " and versao = '$colname_solicitacao_versao' "; 	
} 
...
if( ((isset($_GET["dt_conclusao_fim"])) && ($_GET["dt_conclusao_fim"] != "")) && ($_GET["dt_conclusao_inicio"] == "") ) {
		...
		$where .= " and dt_conclusao <= '".$colname_conclusao_dt_conclusao_fim."' ";
}
...
if( ((isset($_GET["dt_conclusao_inicio"])) && ($_GET["dt_conclusao_inicio"] != "")) && ($_GET["dt_conclusao_fim"] == "") ) {
		...
		$where .= " and dt_conclusao >= '".$colname_conclusao_dt_conclusao_inicio."' ";
}
...
if( ((isset($_GET["dt_conclusao_inicio"])) && ($_GET["dt_conclusao_inicio"] != "")) && ((isset($_GET["dt_conclusao_fim"])) && ($_GET["dt_conclusao_fim"] != "")) ) {
		...
		$where .= " and dt_conclusao between '$colname_conclusao_dt_conclusao_inicio' and '$colname_conclusao_dt_conclusao_fim' "; 
}
...
if( ((isset($_GET["dt_conclusao_testes_fim"])) && ($_GET["dt_conclusao_testes_fim"] != "")) && ($_GET["dt_conclusao_testes_inicio"] == "") ) {
		...
		$where .= " and dt_conclusao_testes <= '".$colname_conclusao_testes_dt_conclusao_testes_fim."' ";
}
...
if( ((isset($_GET["dt_conclusao_testes_inicio"])) && ($_GET["dt_conclusao_testes_inicio"] != "")) && ($_GET["dt_conclusao_testes_fim"] == "") ) {
		...
		$where .= " and dt_conclusao_testes >= '".$colname_conclusao_testes_dt_conclusao_testes_inicio."' ";
}
...
if( ((isset($_GET["dt_conclusao_testes_inicio"])) && ($_GET["dt_conclusao_testes_inicio"] != "")) && ((isset($_GET["dt_conclusao_testes_fim"])) && ($_GET["dt_conclusao_testes_fim"] != "")) ) {
		...
		$where .= " and dt_conclusao_testes between '$colname_conclusao_testes_dt_conclusao_testes_inicio' and '$colname_conclusao_testes_dt_conclusao_testes_fim' "; 
}
...
if( (isset($_GET["protocolo_suporte"])) && ($_GET['protocolo_suporte'] !="") ) {
	...
	$where = $where_usuario_logado." and protocolo_suporte = '$colname_solicitacao_protocolo_suporte' ";
}
...
if( (isset($_GET["id"])) && ($_GET['id'] !="") ) {
	...
	$where = $where_usuario_logado." and id = '$colname_solicitacao_id' ";
}
...
FROM solicitacao 
$where 
ORDER BY solicitacao.previsao_geral ASC";
...
mysql_select_db($database_conexao, $conexao);
$query_filtro_geral_tipo_versao = "SELECT * FROM geral_tipo_versao ORDER BY titulo ASC";
...
$(document).ready(function() {
	...
	// mascara - inicio
	$('#dt_solicitacao_inicio').mask('99-99-9999',{placeholder:" "});
	$('#dt_solicitacao_fim').mask('99-99-9999',{placeholder:" "});
	
	$('#dt_conclusao_inicio').mask('99-99-9999',{placeholder:" "});
	$('#dt_conclusao_fim').mask('99-99-9999',{placeholder:" "});

	$('#dt_conclusao_testes_inicio').mask('99-99-9999',{placeholder:" "});
	$('#dt_conclusao_testes_fim').mask('99-99-9999',{placeholder:" "});

	$('#dt_aprovacao_reprovacao_inicio').mask('99-99-9999',{placeholder:" "});
	$('#dt_aprovacao_reprovacao_fim').mask('99-99-9999',{placeholder:" "});
	
	$('#dt_previsao_inicio').mask('99-99-9999',{placeholder:" "});
	$('#dt_previsao_fim').mask('99-99-9999',{placeholder:" "});
...
<form name="buscar" action="solicitacao.php" method="GET">
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <input name="titulo" type="text" id="titulo" value="<? if ( isset($_GET['titulo']) ) { echo $_GET['titulo']; } ?>" size="110" /> 
            </td>
        ...
        <? } ?>
          ...
          <td style="text-align:right" width="300px">
            <span class="label_solicitacao">Núm. Controle Suporte: </span>
              <input name="protocolo_suporte" type="text" value="<? if ( isset($_GET['protocolo_suporte']) ) { echo $_GET['protocolo_suporte']; } ?>" />
            </td>
        </tr>
    </table>
    </div>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <?php do { ?>
            <option value="<?php echo $row_filtro_geral_tipo_programa['id_programa']?>"
            <?php if ( (isset($_GET['id_programa'])) and (!(strcmp($row_filtro_geral_tipo_programa['id_programa'], $_GET['id_programa']))) ) {echo "selected=\"selected\"";} ?>
            >
            ...
            <? if ( (isset($_GET['id_programa'])) && ($_GET['id_programa'] != "")  ) { // caso possua algum id_programa definido ... ?>
                ...
                mysql_select_db($database_conexao, $conexao);
                $query_filtro_geral_tipo_subprograma = sprintf("SELECT * FROM geral_tipo_subprograma WHERE id_programa = %s ORDER BY subprograma ASC", 
                ...
                ?>
                    ...
                    <?php do { ?>
                    <option value="<?php echo $row_filtro_geral_tipo_subprograma['id_subprograma']?>"
                    <?php if ( (isset($_GET['id_subprograma'])) and (!(strcmp($row_filtro_geral_tipo_subprograma['id_subprograma'], $_GET['id_subprograma']))) ) {echo "selected=\"selected\"";} ?>
                    >
    ...
    <select name="versao">
    <option value=""
    <?php if (!(strcmp("", isset($_GET['versao'])))) {echo "selected=\"selected\"";} ?>
    >
    Escolha ...
    </option>
    <?php do {  ?>
    <option value="<?php echo $row_filtro_geral_tipo_versao['titulo']?>"
    <?php if ( (isset($_GET['versao'])) and (!(strcmp($row_filtro_geral_tipo_versao['titulo'], $_GET['versao']))) ) {echo "selected=\"selected\"";} ?>
    >
    <?php echo $row_filtro_geral_tipo_versao['titulo']?>
    </option>
    <?php
    } while ($row_filtro_geral_tipo_versao = mysql_fetch_assoc($filtro_geral_tipo_versao));
    $rows = mysql_num_rows($filtro_geral_tipo_versao);
    if($rows > 0) {
    mysql_data_seek($filtro_geral_tipo_versao, 0);
    $row_filtro_geral_tipo_versao = mysql_fetch_assoc($filtro_geral_tipo_versao);
    }
    ?>
    </select>
    ...
    <?php do { ?>
    <option value="<?php echo $row_filtro_solicitacao_tipo_solicitacao['titulo']?>"
    <?php if ( (isset($_GET['solicitacao_tipo_solicitacao'])) and (!(strcmp($row_filtro_solicitacao_tipo_solicitacao['titulo'], $_GET['solicitacao_tipo_solicitacao']))) ) {echo "selected=\"selected\"";} ?>
    >
    ...
    <?php do { ?>
    <option value="<?php echo $row_filtro_prioridade['titulo']?>"
    <?php if ( (isset($_GET['prioridade'])) and (!(strcmp($row_filtro_prioridade['titulo'], $_GET['prioridade']))) ) {echo "selected=\"selected\"";} ?>
    >
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            if ( isset($_GET['dt_previsao_inicio']) ){ echo $_GET['dt_previsao_inicio']; }
            ?>" />
            </td>
            ...
            if ( isset($_GET['dt_previsao_fim']) ){ echo $_GET['dt_previsao_fim']; }
            ?>" />
            </td>
        </tr>
    </table>
    ...
    if ( isset($_GET['dt_solicitacao_inicio']) ){ echo $_GET['dt_solicitacao_inicio']; }
    ?>" />
    </td>
    ...
    if ( isset($_GET['dt_solicitacao_fim']) ){ echo $_GET['dt_solicitacao_fim']; }
    ?>" />
    </td>
    </tr>
    </table>
    ...
    if ( isset($_GET['dt_conclusao_inicio']) ){ echo $_GET['dt_conclusao_inicio']; }
    ?>" />
    </td>
    ...
    if ( isset($_GET['dt_conclusao_fim']) ){ echo $_GET['dt_conclusao_fim']; }
    ?>" />
    </td>
    </tr>
    </table>
    ...
    if ( isset($_GET['dt_conclusao_testes_inicio']) ){ echo $_GET['dt_conclusao_testes_inicio']; }
    ?>" />
    </td>
    ...
    if ( isset($_GET['dt_conclusao_testes_fim']) ){ echo $_GET['dt_conclusao_testes_fim']; }
    ?>" />
    </td>
    </tr>
    </table>
    ...
    if ( isset($_GET['dt_aprovacao_reprovacao_inicio']) ){ echo $_GET['dt_aprovacao_reprovacao_inicio']; }
    ?>" />
    </td>
    ...
    if ( isset($_GET['dt_aprovacao_reprovacao_fim']) ){ echo $_GET['dt_aprovacao_reprovacao_fim']; }
    ?>" />
    </td>
    </tr>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <option value=""
            <?php if (!(strcmp("", isset($_GET['solicitante'])))) {echo "selected=\"selected\"";} ?>
            >
            Escolha ...
            </option>
            <?php do {  ?>
            <option value="<?php echo $row_filtro_solicitante['IdUsuario']?>"
            <?php if ( (isset($_GET['solicitante'])) and (!(strcmp($row_filtro_solicitante['IdUsuario'], $_GET['solicitante']))) ) {echo "selected=\"selected\"";} ?>
            >
            ...
            <option value=""
            <?php if (!(strcmp("", isset($_GET['analista_orcamento'])))) {echo "selected=\"selected\"";} ?>
            >
            Escolha ...
            </option>
            <?php do {  ?>
            <option value="<?php echo $row_filtro_analista_orcamento['IdUsuario']?>"
            <?php if ( (isset($_GET['analista_orcamento'])) and (!(strcmp($row_filtro_analista_orcamento['IdUsuario'], $_GET['analista_orcamento']))) ) {echo "selected=\"selected\"";} ?>
            >
            ...
            <option value=""
            <?php if (!(strcmp("", isset($_GET['executante'])))) {echo "selected=\"selected\"";} ?>
            >
            Escolha ...
            </option>
            <?php do {  ?>
            <option value="<?php echo $row_filtro_executante['IdUsuario']?>"
            <?php if ( (isset($_GET['executante'])) and (!(strcmp($row_filtro_executante['IdUsuario'], $_GET['executante']))) ) {echo "selected=\"selected\"";} ?>
            >
          ...
          <td style="text-align: right">
            ...
            <option value=""
            <?php if (!(strcmp("", isset($_GET['testador'])))) {echo "selected=\"selected\"";} ?>
            >
            Escolha ...
            </option>
            <?php do {  ?>
            <option value="<?php echo $row_filtro_testador['IdUsuario']?>"
            <?php if ( (isset($_GET['testador'])) and (!(strcmp($row_filtro_testador['IdUsuario'], $_GET['testador']))) ) {echo "selected=\"selected\"";} ?>
            >
...
if ($row_solicitacao['previsao_geral'] != ""){
	...
	$previsao_geral = funcaoAcrescentaDiasNaoUteis($row_solicitacao['previsao_geral']); // chama a função que altera a data para o próximo dia útil
...

{
    ...
    executante:"<?php if($row_solicitacao['situacao']=="em orçamento" or $row_solicitacao['status']=="encaminhada para analista"){echo $row_solicitacao['nome_analista_orcamento']."*";}else{echo $row_solicitacao['nome_executante'];} ?>",
    testador:"<?php echo $row_solicitacao['nome_testador']; ?>",
    dt_solicitacao:"<? echo $row_solicitacao['dt_solicitacao']; ?>",
    dt_alteracao:"<?

            // alterado a ...
            if ( ($row_solicitacao['previsao_geral'] != "") and ($row_solicitacao['situacao']!="reprovada" and $row_solicitacao['situacao']!="solucionada") ){
                // select solicitacao_descricoes
                $colname_ultima_postagem_validacao = "-1";
                if (isset($row_solicitacao['id'])) {
                $colname_ultima_postagem_validacao = $row_solicitacao['id'];
                }
                mysql_select_db($database_conexao, $conexao);
    ...
    if($row_solicitacao['status']==""){echo "&nbsp;";}

    if($row_solicitacao['status_questionamento']!=""){echo "<strong><font color=red><span class='ponto_interrogacao' id='".$row_solicitacao['id']."'>?</span></font></strong> ";}

    if($row_solicitacao['status']=="pendente solicitante"){echo "PenSol";}
    if($row_solicitacao['status']=="pendente operador"){echo "PenOpe";}
    if($row_solicitacao['status']=="pendente executante"){echo "PenExe";}
    if($row_solicitacao['status']=="pendente testador"){echo "PenTes";}

    if($row_solicitacao['status']=="encaminhada para solicitante"){echo "EncSol";}
    if($row_solicitacao['status']=="encaminhada para operador"){echo "EncOpe";}
    if($row_solicitacao['status']=="encaminhada para executante"){echo "EncExe";}
    if($row_solicitacao['status']=="encaminhada para testador"){echo "EncTes";}
    if($row_solicitacao['status']=="encaminhada para analista"){echo "EncAna";}
    
    if($row_solicitacao['status']=="devolvida para solicitante"){echo "DevSol";}
    if($row_solicitacao['status']=="devolvida para operador"){echo "DevOpe";}
    if($row_solicitacao['status']=="devolvida para executante"){echo "DevExe";}
    if($row_solicitacao['status']=="devolvida para testador"){echo "DevTes";}
...
<?php } while ($row_solicitacao = mysql_fetch_assoc($solicitacao)); ?>
    ...
    jQuery('#solicitacao').jqGrid({
        data:dados,
        datatype: 'local',
        colNames:['Núm','Título', 'Empresa','Solicitante','Operador','Executante','Testador','Criação','Alterado a','Tipo','Status','Prior.','Situação',''],
        colModel :[ 
            {name:'id', index:'id', width:25, sorttype: 'integer'}, 
            {name:'titulo', index:'titulo'}, 
            {name:'empresa', index:'empresa', width:100, align:'left'}, 
            {name:'solicitante', index:'solicitante', width:60, align:'left'}, 
            {name:'operador', index:'operador', width:60, align:'left'}, 
            {name:'executante', index:'executante', width:60, align:'left'}, 
            {name:'testador', index:'testador', width:60, align:'left'}, 
            {name:'dt_solicitacao', index:'dt_solicitacao', width:50, formatter:'date', formatoptions: { srcformat: "ISO8601Long", newformat: "d-m-Y" }, align:'center' },
            ...
            {name:'prioridade', index:'prioridade', width:30, align:'center'},
