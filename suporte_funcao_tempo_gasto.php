<?
function tempo_gasto($id_suporteHG, $situacaoHG, $acaoHG, $id_usuarioHG, $responsabilidadeHG, $tempo_gastoHG){
    ...
    $insertSQL_HORA_GASTA  = sprintf("INSERT INTO suporte_tempo_gasto (id_suporte, data, tempo_gasto, dia, hora, minuto, id_usuario, responsabilidade, situacao, acao, total_em_minutos) 
                                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($id_suporteHG, "int"),
