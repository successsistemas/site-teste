...
jQuery.validator.addMethod("dateTimeBR", function(value, element) {
	 ...
	 //contando chars
	if(value.length != 16){if(value.length != 19){return false;}}
	...
	var doispontos1 = horario.substr(2,1);
	...
	if(horario.length!=horario_length||isNaN(hora)||isNaN(minuto)||isNaN(segundo)||hora>23||minuto>59||segundo>59||doispontos1!=":"||doispontos2!=":")return false;
	return true;
