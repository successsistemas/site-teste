...
SELECT 
    da37.codigo17, da37.cliente17, da37.status17, da37.obs17, da37.tpocont17, da37.visita17, da37.optacuv17, da37.versao17, da37.espmod17, da37.datcont17, versao17, espmod17, vendedor17, porsal17, 
...
FROM 
    da37 
INNER JOIN 
    geral_tipo_contrato ON geral_tipo_contrato.IdTipoContrato = da37.tpocont17
INNER JOIN 
    geral_tipo_visita ON geral_tipo_visita.IdTipoVisita = da37.visita17
INNER JOIN 
    geral_tipo_praca_executor ON geral_tipo_praca_executor.IdExecutor = da37.vendedor17
WHERE 
    da37.codigo17 = %s and da37.sr_deleted <> 'T'
", 
...
SELECT codigo1, nome1, fantasia1, contato1, endereco1, bairro1, cidade1, uf1, telefone1, comercio1, cep1, ultcompra1, atraso1, status1, flag1, tipo1, atraso1 
FROM da01 
...
SELECT id, data_suporte, status, tipo_suporte, inloco, cobranca, visita_bonus  
FROM suporte 
...
Contato: <?php echo $row_empresa_dados['contato1']; ?> | Praça: <? echo $row_manutencao_dados['vendedor17_praca']; ?>
</div>
...
<? if($totalRows_manutencao_dados > 0){ ?>
    ...
    <div class="linha1">
                ...
                <?php do { ?>
                    ...
                    <?php if($row_suportes_encerrados['visita_bonus']=="s"){echo "Bônus | ";} ?> 
        ...
        <table border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px; margin-bottom: 10px;">
            ...
            <? if($row_empresa_dados['status1']=="0" and $row_empresa_dados['flag1']=="0"){ ?>
                ...
                <form action="suporte_gerar.php" name="form_clientes" id="form_clientes" method="get" class="cmxform">
                    ...
                    <? if ($_SESSION['MM_praca'] == $row_manutencao_dados['vendedor17_praca']){ ?>
            ...
            <? if($row_empresa_dados['status1']=="0" and ($row_manutencao_dados['status17'] <> "C")){ ?>
            <td>
            <!-- reclamacao -->
