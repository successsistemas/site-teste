...
@media screen and (-webkit-min-device-pixel-ratio:0) { 
	html {
		margin-left: 1px; /* 1px margin on Google Chrome (conserta bug) */
	}
}
@page { size: landscape; }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <td width="25%">
        Visita bônus: 
        <div><? if($row_suporte_formulario['visita_bonus']=="s"){echo "Sim";}else{echo "Não";}; ?></div>

        </td>
        
        <td width="25%">
        <div>(<?php if($row_manutencao_dados['espmod17']=="O"){echo "X";}else{echo " ";} ?>) Oficce</div>
        <div>(<?php if($row_manutencao_dados['espmod17']=="B"){echo "X";}else{echo " ";} ?>) Standard</div>
        </td>
        
        <td width="25%">
        <div>(<?php if($row_manutencao_dados['versao17']=="1"){echo "X";}else{echo " ";} ?>) DOS</div>
        <div>(<?php if($row_manutencao_dados['versao17']=="2"){echo "X";}else{echo " ";} ?>) Windows</div>
        </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bordasimples">
    ...
    <? do{ ?>
      <tr>
        ...
        <td class="titulo_dados_atendimento" style="text-align: left; font-size: 9px"><?php if($row_suporte_ultimos['inloco']=="s"){echo "Sim";} if($row_suporte_ultimos['inloco']=="n"){echo "Não";} ?></td>
        ...
        <td class="titulo_dados_atendimento" style="text-align: left; font-size: 9px"><?php $texto = $row_suporte_ultimos['anomalia']; $texto_limite = 38; if (strlen($texto) > $texto_limite){$texto = substr($texto, 0, $texto_limite) . '...';} echo $texto; ?></td>
