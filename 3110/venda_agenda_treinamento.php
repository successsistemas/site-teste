...
if( $data_atual_ativo == "1" ) {
		...
		$where .= " and venda_agenda_treinamento.data_inicio between '$colname_venda_data_inicio_fim 00:00:00' and '$colname_venda_data_inicio_fim 23:59:59' ";
...
// se NÃO existe filtro de data_atual
		...
		$where .= " and venda_agenda_treinamento.data_inicio <= '$colname_venda_data_inicio_fim 23:59:59' ";
...
$query_venda = "
SELECT 
venda_agenda_treinamento.id_venda, venda_agenda_treinamento.data, venda_agenda_treinamento.data_inicio, venda_agenda_treinamento.descricao,
...
FROM venda_agenda_treinamento 
INNER JOIN venda ON venda_agenda_treinamento.id_venda = venda.id
WHERE $where and (venda_agenda_treinamento.status = 'a' or venda_agenda_treinamento.status = 'g')
ORDER BY venda_agenda_treinamento.data ASC";
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        <form method="get" id="form_usuario_responsavel_alterar" name="form_usuario_responsavel_alterar" action="venda_agenda_treinamento.php">
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td style="text-align:left">
            ...
            <? funcao_agenda_calendario($dia, $mes, $ano, 'venda_agenda_treinamento.php?id_usuario_atual='.$row_usuario_atual['IdUsuario'].'&'); ?>
            </div>
            <!-- funcao_agenda_calendário -->
		</td>
	</tr>
...
?>
<a href="venda_agenda_treinamento.php?id_usuario_atual=<? echo $row_usuario_atual['IdUsuario']; ?>&data_atual=<? echo $data_ant; ?>" class="botao_geral2" style="width: 150px">&lt;&lt; anterior</a>

<a href="venda_agenda_treinamento.php?id_usuario_atual=<? echo $row_usuario_atual['IdUsuario']; ?>&data_atual=<? echo $data_pro; ?>" class="botao_geral2" style="width: 150px">próximo &gt;&gt;</a>
...
<form action="venda_agenda_treinamento_imprimir.php" method="post" target="_blank" id="form" name="form">
