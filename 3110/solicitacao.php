...
SELECT 
    ...
    (
    case 
        when DAYOFWEEK(solicitacao.previsao_geral) = 1 then ADDDATE(solicitacao.previsao_geral, INTERVAL 1 DAY)
        when DAYOFWEEK(solicitacao.previsao_geral) = 7 then ADDDATE(solicitacao.previsao_geral, INTERVAL 2 DAY)
    else solicitacao.previsao_geral end 
    ) AS previsao_geral_proximoDiaUtil, 
...

                        {
                            ...
                            if ( $row_solicitacao['situacao']!="reprovada" and $row_solicitacao['situacao']!="solucionada" ){
                                ...
                                if($row_solicitacao['previsao_geral'] <> NULL){
                                    ...
                                    //$previsao_limite = $row_solicitacao['previsao_geral_proximoDiaUtil']; 
