...
border=0 valign="top">
    ...
    align=center><BR>
      ...
      cellSpacing=0 cellPadding=0 width=700>
                  ...
                  style="MARGIN-BOTTOM: 35px; FONT-SIZE: 26px; FONT-FAMILY: Arial, sans-serif; FONT-WEIGHT: bold; COLOR: #fff; TEXT-ALIGN: center; MARGIN-TOP: 38px; DISPLAY: block; LETTER-SPACING: 0px">Título desejado.</SPAN></TD>
										</TR>
									</TBODY>
								</TABLE></TD>
							<TD width=40></TD>
      ...
      width=700>
          ...
          style="PADDING-BOTTOM: 40px; TEXT-ALIGN: center; PADDING-TOP: 15px"><P 
            style="FONT-SIZE: 16px; FONT-FAMILY: Arial, sans-serif; COLOR: #666; PADDING-BOTTOM: 20px; LINE-HEIGHT: 150%"> <p>Paracatu, <? echo data_por_extenso(date('Y-m-d')); ?></p> <BR>
									...
									<BR>
									<BR>
									<SPAN style="FONT-SIZE: 16px">Aqui vem o texto...</SPAN></P>
								<BR>
								<BR>
								<P 
