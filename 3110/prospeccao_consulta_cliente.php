...
$query_cliente_selecionado = sprintf("
									 SELECT pessoa1, nome1, fantasia1, cgc1, insc1, cep1, endereco1, bairro1, cidade1, uf1, telefone1, celular1 
									 FROM da01 
									 WHERE codigo1 = %s and da01.sr_deleted <> 'T'", GetSQLValueString($id_atual, "text"));
...
$return_data=array(
				   ...
				   'cgc1' => utf8_encode($row_cliente_selecionado['cgc1']), 
				   'insc1' => utf8_encode($row_cliente_selecionado['insc1']), 
