...
mysql_select_db($database_conexao, $conexao);
$query_arquivos_anexados = sprintf("SELECT * FROM suporte_arquivos WHERE id_suporte = %s ORDER BY id_arquivo DESC", GetSQLValueString($colname_arquivos_anexados, "int"));
