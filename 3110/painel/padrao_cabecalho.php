...
<div class="topo" style="background-image: url(../../imagens/topo_painel.png); width: 1000px; height: 200px; margin-left: auto; margin-right: auto; margin-bottom: 20px;">
</div>
...
<? if (isset($_SESSION['MM_Username'])) { ?> 
    ...
    <div style="text-align: right; border: 2px solid #B3D0E7; padding: 5px; margin-top: 30px; margin-bottom: 10px;">
