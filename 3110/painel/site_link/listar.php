                        ...
                        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                          <thead>
                            <tr class="KT_row_order">
                              ...
                              <th id="titulo" class="KT_sorter KT_col_titulo <?php echo $tso_listsite_link1->getSortIcon('site_link.titulo'); ?>"> <a href="<?php echo $tso_listsite_link1->getSortLink('site_link.titulo'); ?>">Título</a> </th>
                              <th>&nbsp;</th>
                            </tr>
                          </thead>
                          <tbody>
