...
?>
                ...
                <div class="caminho"><a href="../index.php">Página inicial</a> &gt;&gt; Implantacao - Pergunta</div>
                <!-- fim - titulo -->
                      ...
                      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                        <thead>
                          <tr class="KT_row_order">
                            ...
                            <th id="codigo" class="KT_sorter KT_col_codigo <?php echo $tso_listimplantacao_pergunta1->getSortIcon('implantacao_pergunta.codigo'); ?>"> <a href="<?php echo $tso_listimplantacao_pergunta1->getSortLink('implantacao_pergunta.codigo'); ?>">Código</a> </th>
                            <th id="id_modulo" class="KT_sorter KT_col_id_modulo <?php echo $tso_listimplantacao_pergunta1->getSortIcon('implantacao_pergunta.id_modulo'); ?>"> <a href="<?php echo $tso_listimplantacao_pergunta1->getSortLink('implantacao_pergunta.id_modulo'); ?>">Módulo</a> </th>
                            ...
                            <th id="permite_lancamentos" class="KT_sorter KT_col_permite_lancamentos <?php echo $tso_listimplantacao_pergunta1->getSortIcon('implantacao_pergunta.permite_lancamentos'); ?>"> <a href="<?php echo $tso_listimplantacao_pergunta1->getSortLink('implantacao_pergunta.permite_lancamentos'); ?>">Perm Lanç.</a> </th>
                          ...
                          <?php if ($totalRows_rsimplantacao_pergunta1 > 0) { // Show if recordset not empty ?>
                            <?php do { ?>
                              <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                                ...
                                <?php if($row_rsimplantacao_pergunta1['permite_lancamentos']=="n"){ ?><span style="color: red;">Não</span><? } ?>
                                </td>
                                <td>
								<?php if($row_rsimplantacao_pergunta1['office']=="s"){ ?><span style="color: green;">Sim</span><? } ?>
                                <?php if($row_rsimplantacao_pergunta1['office']=="n"){ ?><span style="color: red;">Não</span><? } ?>
                                </td>
                                <td>
								<?php if($row_rsimplantacao_pergunta1['standard']=="s"){ ?><span style="color: green;">Sim</span><? } ?>
                                <?php if($row_rsimplantacao_pergunta1['standard']=="n"){ ?><span style="color: red;">Não</span><? } ?>
                                </td>
                                <td>
