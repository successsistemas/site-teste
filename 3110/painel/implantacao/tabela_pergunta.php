...
<div class="KT_tng">
    ...
    <option value="n" <?php if (!(strcmp("n", KT_escapeAttribute($row_rsimplantacao_pergunta['permite_lancamentos'])))) {echo "selected=\"selected\"";} ?>>Não</option>
    </select>
    <? } else { ?>
    
    	<span style="font-weight: bold;">
        <?php if (!(strcmp("s", KT_escapeAttribute($row_rsimplantacao_pergunta['permite_lancamentos'])))) {echo "Sim";} ?>
        <?php if (!(strcmp("n", KT_escapeAttribute($row_rsimplantacao_pergunta['permite_lancamentos'])))) {echo "Não";} ?>
        </span>
...
?>
    ...
    <option value="n" <?php if (!(strcmp("n", KT_escapeAttribute($row_rsimplantacao_pergunta['office'])))) {echo "selected=\"selected\"";} ?>>Não</option>
    </select>
    ...
    <option value="n" <?php if (!(strcmp("n", KT_escapeAttribute($row_rsimplantacao_pergunta['standard'])))) {echo "selected=\"selected\"";} ?>>Não</option>
    </select>
