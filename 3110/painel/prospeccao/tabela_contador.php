...
$ins_prospeccao_contador->registerTrigger("END", "Trigger_Default_Redirect", 99, "listar_contador.php");
// Add columns
...
$upd_prospeccao_contador->registerTrigger("END", "Trigger_Default_Redirect", 99, "listar_contador.php");
// Add columns
...
$del_prospeccao_contador->registerTrigger("END", "Trigger_Default_Redirect", 99, "listar_contador.php");
