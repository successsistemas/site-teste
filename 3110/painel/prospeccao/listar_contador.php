	...
	<div class="texto"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">Prospecção - Contador <?php
...
?>
                ...
                <div class="caminho"><a href="../index.php">Página inicial</a> &gt;&gt; Prospecção - Contador</div>
                <!-- fim - titulo -->
                      ...
                      <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                        <thead>
                          <tr class="KT_row_order">
                            ...
                            <th id="id" class="KT_sorter KT_col_id <?php echo $tso_listprospeccao_contador1->getSortIcon('prospeccao_contador.id'); ?>"> <a href="<?php echo $tso_listprospeccao_contador1->getSortLink('prospeccao_contador.id'); ?>">Código</a> </th>
