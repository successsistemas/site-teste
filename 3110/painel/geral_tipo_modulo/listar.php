	...
	<div class="texto"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left">Tipo de Módulo <?php
...
?></td>
                ...
                <div class="caminho"><a href="../index.php">Página inicial</a> &gt;&gt; <a href="listar_categoria.php">Categorias</a> &gt;&gt; Tipo de Módulo</div>
                <!-- fim - descricao -->
                        ...
                        <table cellpadding="2" cellspacing="0" class="KT_tngtable">
                          <thead>
                            <tr class="KT_row_order">
                              ...
                              <th id="IdTipoModulo" class="KT_sorter KT_col_IdTipoModulo <?php echo $tso_listgeral_tipo_modulo1->getSortIcon('geral_tipo_modulo.IdTipoModulo'); ?>"> <a href="<?php echo $tso_listgeral_tipo_modulo1->getSortLink('geral_tipo_modulo.IdTipoModulo'); ?>">Código</a></th>
                              ...
                              <th id="descricao" class="KT_sorter KT_col_descricao <?php echo $tso_listgeral_tipo_modulo1->getSortIcon('geral_tipo_modulo.descricao'); ?>"> <a href="<?php echo $tso_listgeral_tipo_modulo1->getSortLink('geral_tipo_modulo.descricao'); ?>">Título</a></th>
                              <th>&nbsp;</th>
                            </tr>
                          </thead>
                          <tbody>
