    ...
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td style="text-align:left">
                ...
                <font color="#3399CC"> | </font>
                <a href="agenda.php?padrao=sim&<? echo $agenda_padrao; ?>" style="color: #D1E3F1">Agenda</a>
            </td>
...
<div id="gerar_relatorio" style="display: none;">
    <form action="agenda_relatorio.php" method="post" target="_blank" id="form" name="form">
        ...
        <input type="hidden" name="relatorio_tipo" value="agenda" />
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="33%" valign="top">
                            ...
                            <input value="data_modulo" type="checkbox" name="relatorio_campos[]" checked />
                            Emissão
                            <br>

                            <input value="data_inicio" type="checkbox" name="relatorio_campos[]" checked />
                            Previsão
                            <br>

                            <input value="hora_inicio" type="checkbox" name="relatorio_campos[]" checked />
                            Início
                            <br>
                            ...
                            <input value="usuarios_nome" type="checkbox" name="relatorio_campos[]" checked />
                            Responsável
                            <br>
                        ...
                        <td width="33%" valign="top">
                            ...
                            <input value="descricao" type="checkbox" name="relatorio_campos[]" checked />
                            Descrição
                            <br>

                            <input value="modulo" type="checkbox" name="relatorio_campos[]" checked />
                            Módulo
                            <br>

                            <input value="prioridade_label" type="checkbox" name="relatorio_campos[]" checked />
                            Prioridade
                            <br>

                            <input value="situacao_label" type="checkbox" name="relatorio_campos[]" checked />
                            Situação
                            <br>

                            <input value="praca" type="checkbox" name="relatorio_campos[]" checked />
                            Praça
                            <br>
        ...
        <!-- rodapé -->
        <div>Obs: este relatório é baseado nos filtros utilizados na tela anterior de listagem da agenda.</div>
