...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        <?php if($row_venda['status_flag'] == "a"){ ?>
			<?php if($row_usuario['praca'] == 'PARACATU'){ ?>
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
		...
		<td style="text-align:right">
        Última compra: <strong><? if($row_empresa_dados['ultcompra1']!=""){ echo date('d-m-Y', strtotime($row_empresa_dados['ultcompra1'])); } ?></strong> | 
...
<table cellspacing="0" cellpadding="0" width="100%">
	<tr>
        ...
        <span class="label_solicitacao">Valor da venda do software: </span>R$ <? echo number_format($row_venda['valor_venda'], 2, ',', '.'); ?><br><span class="label_solicitacao">Valor da venda do treinamento: </span>R$ <? echo number_format($row_venda['valor_treinamento'], 2, ',', '.'); ?>
        </td>
	</tr>
</table>
</div>
...
or
($row_venda['encaminhamento_id']==$row_usuario['IdUsuario'] and
												   
		$row_venda['status_flag'] == "a" and 
												   
		(
		$row_venda['situacao']=="analisada"
		)
...
// fim - controle_venda =================================================================================================
	...
	<? if(
		  // controlador_venda
		  ($row_usuario['controle_venda'] == "Y" and $row_venda['dilacao_prazo_proposto'] > 0)
		  ...
		  (
			...
			($row_usuario['nivel_venda'] == 2 and $row_usuario['praca'] == $row_venda['praca'])
			) and 
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <div style="font-weight: bold;">Implantação:</div>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;">
        ...
        <tr bgcolor="<? if(($contador_agenda % 2)==1){echo "#F1F1F1";}else{echo "#FFFFFF";} ?>">
            ...
            <td style="padding: 5px;">
				<?php if($row_agenda_implantacao['status']=="a"){echo "Agendado";}?>
                <?php if($row_agenda_implantacao['status']=="f"){echo "Finalizado";}?>
                <?php if($row_agenda_implantacao['status']=="c"){echo "Cancelado";}?>
            </td> 
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <div style="font-weight: bold;">Treinamento:</div>
    <div style="height: 2px; background-color: #CCC; margin-top: 5px; margin-bottom: 5px;"></div>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;">
        ...
        <tr bgcolor="<? if(($contador_agenda % 2)==1){echo "#F1F1F1";}else{echo "#FFFFFF";} ?>">
            ...
            <td style="padding: 5px;">
				<?php if($row_agenda_treinamento['status']=="a"){echo "Agendado";}?>
                <?php if($row_agenda_treinamento['status']=="f"){echo "Finalizado";}?>
                <?php if($row_agenda_treinamento['status']=="c"){echo "Cancelado";}?>
            </td> 
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 5px;">
        ...
        <?php do { ?>
        <tr bgcolor="<? if(($contador_reclamacao_venda % 2)==1){echo "#F1F1F1";}else{echo "#FFFFFF";} ?>">
...
<table cellspacing="0" cellpadding="0" width="100%">
  <tr>
	...
	<? if($row_venda['situacao']!="solucionada" and $row_venda['situacao']!="cancelada"){ ?>            
            ...
            <br>       
            <? if($row_venda['usuario_responsavel_leu']!=""){ echo date('d-m-Y - H:i:s', strtotime($row_venda['usuario_responsavel_leu'])); } else { echo "não leu"; } ?>
			<? } else { ?>
            	<br><br>
